...
Every request is logged as one JSON line without bodies, tokens or usernames; see [Operations](HOSTING.md#operations) for the fields, `X-Request-Id` handling and the loopback-only `GET /internal/metrics`.
